...
countsDFa = (
    ...
    .csv("/mnt/taxidata/output3a.csv")
)
countsDFb = (
    spark.read.option("header", "true")
    .option("inferSchema", "true")
    .csv("/mnt/taxidata/output3b.csv")
)
...
countsDFb = spark.createDataFrame(
    list(findPopularQuarter(dataList).items()), schema=["Quarter", "Count"]
)
...
dbutils.fs.cp(
    ...
    + "@"
    + storage_account_name
    + ".blob.core.windows.net/output3a.csv",
)
dbutils.fs.rm(
    "wasbs://"
    + storage_container_name
...
dbutils.fs.cp(
    ...
    + "@"
    + storage_account_name
    + ".blob.core.windows.net/output3b.csv",
)
dbutils.fs.rm(
    "wasbs://"
    + storage_container_name
